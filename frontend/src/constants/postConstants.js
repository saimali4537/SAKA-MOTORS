...
export const POST_S_LIST_REQUEST = 'POST_S_LIST_REQUEST'
export const POST_S_LIST_SUCCESS = 'POST_S_LIST_SUCCESS'
export const POST_S_LIST_FAIL = 'POST_S_LIST_FAIL'
...
export const POST_TOP_RESET = 'POST_TOP_RESET'
