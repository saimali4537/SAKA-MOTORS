...
const BidEditScreen = ({ match, history }) => {
  ...
  const bidUpdate = useSelector((state) => state.bidUpdate)
  const {
  ...
  , [dispatch, history, bidId, bid, successUpdate])
