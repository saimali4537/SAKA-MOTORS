...
const ForgetScreenMM = ({ location, history }) => {
  ...
  const redirect = location.search ? location.search.split('=')[2] : '/mechanic/loginmm'
  ...
  return (
    <FormContainer>
      ...
      <Col>
          Forgot Password?{' '}
          <Link to={redirect ? `/mechanic/forgetm?redirect=${redirect}` : '/mechanic/forgetm'}>
            Forget
          </Link>
        </Col>
      </Row>
      ...
      <Row className='py-3'>
        <Col>
          Have an account?{' '}
          <Link to={redirect ? `/mechanic/loginmm?redirect=${redirect}` : '/mechanic/loginmm'}>
            Login
          </Link>
        </Col>
      </Row><br/><br/>
